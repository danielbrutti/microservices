...
export class DeveloperComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.developerService.search({
                ...
                (res: HttpResponse<Developer[]>) => this.onSuccess(res.body, res.headers),
    ...
    registerChangeInDevelopers() {
        this.eventSubscriber = this.eventManager.subscribe('developerListModification', (response) => this.reset());
    }
